<?php
/**
 * Steep functions and definitions
 *
 * @package Steep
 */
...
function steep_register_sidebars() {
	...
	hybrid_register_sidebar(
		array(
			'id'          => 'header-right',
			'name'        => _x( 'Header Right', 'sidebar', 'steep' ),
			'description' => __( 'Sidebar for header right area.', 'steep' )
		)
	);
	...
	hybrid_register_sidebar(
		array(
			'id'   => 'home-widget-area',
			'name' => _x( 'Home Widget Area', 'sidebar', 'steep' ),
		)
	);
...
function steep_register_menus() {
	...
	register_nav_menu( 'footer', _x( 'Footer', 'nav menu location', 'steep' ) );
